...
/**
 * LankaPay (formerly LankaClear) national payment network of Sri Lanka which provides
 * the central payment infrastructure to the country's financial sector.
 *
 * @see https://en.wikipedia.org/wiki/LankaPay
 * @see https://en.wikipedia.org/wiki/Payment_card_number#Issuer_identification_number_(IIN)
 */
final class LankaPay extends AbstractCreditCardBrand
{
    /**
     * The unique identifier for the LankaPay.
     * @var non-empty-lowercase-string
     */
    public const ID = 'lankapay';
     ...
     */
    protected string $name = 'LankaPay';

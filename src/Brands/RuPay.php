...
/**
 * RuPay (portmanteau of Rupee and Payment) is an Indian multinational financial services
 * and payment service system, conceived and owned by the National Payments Corporation of India (NPCI)
 *
 * @see https://en.wikipedia.org/wiki/RuPay
 * @see https://en.wikipedia.org/wiki/Payment_card_number#Issuer_identification_number_(IIN)
 */
final class RuPay extends AbstractCreditCardBrand
{
    /**
     * The unique identifier for the RuPay card brand.
     * @var non-empty-lowercase-string
     */
    public const ID = 'rupay';
    ...
    protected array $iinList = [
        ...
        353,
        356,
        // default IIN range for RuPay cards
        508,
        60,
        65,
        81,

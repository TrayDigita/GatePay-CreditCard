...
/**
 * Visa is a global payments technology company that facilitates electronic funds transfers worldwide,
 * most commonly through Visa-branded credit cards, debit cards, and prepaid cards.
 * Visa cards are widely accepted by merchants around the world
 * and are known for their security features and reliability.
 *
 ...
 */
final class Visa extends AbstractCreditCardBrand
{
    /**
     * The unique identifier for the VISA.
     * @var non-empty-lowercase-string
     */
    public const ID = 'visa';
     ...
     * @see https://www.iso.org/standard/70484.html
     */
    protected array $panLengths = [13, 16, 19];

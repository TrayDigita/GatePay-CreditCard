...
/**
 * Diners Club International Ltd. (DCI) (United States & Canada),
 * founded as Diners Club, is a charge card company owned by Capital One.
 ...
 */
final class DinersClub extends AbstractCreditCardBrand
{
    /**
     * The unique identifier Dinners Club.
     * @var non-empty-lowercase-string
     */
    public const ID = 'diners-club';
     ...
     */
    protected string $name = 'Diners Club (United States & Canada)';

...
/**
 * Borica is a credit card brand issued primarily in Bulgaria.
 * It was introduced in 2000 and is currently issued by Borica AD, a Bulgarian payment processing company.
 *
 * @see https://en.wikipedia.org/wiki/Payment_card_number#Issuer_identification_number_(IIN)
 */
final class Borica extends AbstractCreditCardBrand
{
    /**
     * The unique identifier for the Borica.
     * @var non-empty-lowercase-string
     */
    public const ID = 'borica';

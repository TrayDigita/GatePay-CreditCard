...
/**
 * Turkey's Payment Method, TROY, was established in 2016 within the Interbank Card Center.
 *
 * @see https://en.wikipedia.org/wiki/Troy_(card_scheme)
 * @see https://en.wikipedia.org/wiki/Payment_card_number#Issuer_identification_number_(IIN)
 */
final class Troy extends AbstractCreditCardBrand
{
    /**
     * The unique identifier for the Troy.
     * @var non-empty-lowercase-string
     */
    public const ID = 'troy';
    ...
    public function isValid(string $pan): bool
    {
        ...
        if (!str_starts_with($pan, '9792') && !str_starts_with($pan, '65')) {
            return false;
        }
        try {
